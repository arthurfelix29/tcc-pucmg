...
namespace MicrosservicoAdministrativo.UnitTests.Controllers.V1
{
	...
	public class TipoEmpresaControllerTest
	{
		...
		[Fact]
		public void TipoEmpresaControllerTest_Excluir_PassandoGuidInexistente_Retorna404()
		{
			_serviceMock.Setup(x => x.ObterPorId(It.IsAny<Guid>())).Returns(() => null);
		...
		[Fact]
		public void TipoEmpresaControllerTest_Excluir_PassandoGuidExistente_Retorna204()
		{
			var result = _controller.Excluir(It.IsAny<Guid>());
